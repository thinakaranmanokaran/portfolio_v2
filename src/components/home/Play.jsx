...
const Play = () => {
    ...
    const SecondCards = () => {
        ...
        const OldPortfolio = () => {
            return (
                <div className=' p-2  rounded-3xl flex flex-col text-light justify-between relative bg-purple'  >
        ...
        const GitStreak = () => {
            return (
                <div className='bg-yellow h-100% p-4 rounded-3xl relative flex flex-col items-center ' >
    ...
    const ThirdCards = () => {
        ...
        const NoteCard = () => {
            return (
                <div className='w-fit' >
                    <div className='bg-light w-full h-full max-w-[40vw] rounded-3xl shadow-bento ' >
    ...
    return (
        <div className='flex justify-center ' >
            <motion.div  initial={{ width: "200px", height: "100px" , overflow: "hidden",    }} whileInView={{ width: "auto", height: "auto",  }} transition={{ duration: 1, ease: "easeInOut" }} className='w-fit rounded-3xl border-2 border-[#ffffff20] h-fit bg-grey bg-opacity-5 backdrop-blur-md  p-10 px-10 space-y-4' >
                <TopCards />
                <SecondCards />
                <ThirdCards />
            </motion.div >
